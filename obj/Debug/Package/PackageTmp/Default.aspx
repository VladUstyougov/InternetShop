...
-webkit-border-radius: 3px 3px 3px 3px;
                                                ...
                                                width: 300px; -moz-box-shadow: 0px 4px 3px -3px rgba(0, 0, 0, 0.28);-webkit-box-shadow: 0px 4px 3px -3px rgba(0, 0, 0, 0.28);box-shadow: 0px 4px 3px -3px rgba(0, 0, 0, 0.28); color: #000;
...
-webkit-border-radius: 3px 3px 3px 3px;
                                                    ...
                                                    background-image: -moz-linear-gradient(center top , #517BA5, #094581);
                                                    padding: 0px;
                                                    border-style: solid; 
                                                    border-width: 1px; 
                                                    font-weight: normal; 
